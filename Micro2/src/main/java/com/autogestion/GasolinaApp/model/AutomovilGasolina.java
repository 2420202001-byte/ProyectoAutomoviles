...
public class AutomovilGasolina extends Automovil implements IAplicable {
    ...
    @OneToMany(mappedBy = "automovilGasolina", cascade = CascadeType.ALL)
    ...
    public void setConsumoLitrosPor100Km(double v) {
        this.consumoLitrosPor100Km = v;
    }

    public double getCapacidadTanqueLitros() {
        return capacidadTanqueLitros;
    }

    public void setCapacidadTanqueLitros(double v) {
        this.capacidadTanqueLitros = v;
    }
