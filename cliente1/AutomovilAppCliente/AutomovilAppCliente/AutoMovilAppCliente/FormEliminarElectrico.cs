...
{
    public partial class FormEliminarElectrico : Form
    {
        ...
        {
            this.Text = "Eliminar Automóvil Eléctrico";
            this.Size = new System.Drawing.Size(820, 460);
            this.StartPosition = FormStartPosition.CenterScreen;

            var panelHeader = new Panel { Dock = DockStyle.Top, Height = 65, BackColor = colorPrimario };
            var lblTitulo = new Label { Text = "🗑️  Eliminar Automóvil Eléctrico", Font = new System.Drawing.Font("Segoe UI Semibold", 14f, System.Drawing.FontStyle.Bold), ForeColor = colorAcento, AutoSize = true, Location = new System.Drawing.Point(20, 18) };
            panelHeader.Controls.Add(lblTitulo);

            var panelBusqueda = new FlowLayoutPanel { Dock = DockStyle.Top, Height = 55, Padding = new Padding(10) };
            panelBusqueda.Controls.Add(new Label { Text = "ID a eliminar:", AutoSize = true, Font = new System.Drawing.Font("Segoe UI", 8f, System.Drawing.FontStyle.Bold), ForeColor = colorSubTexto });
            ...
            dgvResultado = new DataGridView { Dock = DockStyle.Fill, ReadOnly = true, AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill, BackgroundColor = colorPanel, BorderStyle = BorderStyle.None, EnableHeadersVisualStyles = false };
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                var client = new RestClient(BASE_URL);
                var request = new RestRequest($"/electricos/{id}", Method.Delete);
                var response = client.Execute(request);
