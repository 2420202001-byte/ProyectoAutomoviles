...
namespace AutoMovilAppCliente
{
    public partial class FormAdicionarElectrico : Form
    {
        ...
        private void CrearFormulario()
        {
            ...
            var lblTitulo = new Label { Text = "⚡  Adicionar Automóvil Eléctrico", Font = new Font("Segoe UI Semibold", 14f, FontStyle.Bold), ForeColor = colorAcento, AutoSize = true, Location = new Point(20, 18) };
            ...
            cboBateria = new ComboBox { Width = 350, DropDownStyle = ComboBoxStyle.DropDownList, Font = new Font("Segoe UI", 9f), BackColor = colorFondo, ForeColor = colorTexto };

            System.Windows.Forms.Control[] campos = { txtId, txtMarca, txtModelo, txtAnio, txtColor, txtPrecio, txtAutonomia, txtTiempoCarga, cboBateria };
